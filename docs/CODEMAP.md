...
| Apply the approved body/language/leverage growth, behavior-changing Modifier proof, effect-presentation rules, and ten-Verb/ten-Modifier breadth probes | [Power Progression Direction](POWER-PROGRESSION-DIRECTION.md) |
| Apply the approved atmosphere, contextual information hierarchy, required semantic sound, and three selected experience journeys | [Experience Pass 1 — From Harness to Game](EXPERIENCE-PASS-1-FROM-HARNESS-TO-GAME.md) |
| Implement or review the approved presentation-only Goal 7C boundary, six frozen fixture decisions, retained gate, and three UAT profiles | [Goal 7C — From Harness to Game](GOAL-7C-FROM-HARNESS-TO-GAME.md) |
| Apply the source-backed inspiration boundaries and decision protocol behind Palimpsest's Creative Director | [Palimpsest's Creative Director Research](PALIMPSEST-CREATIVE-DIRECTOR-RESEARCH.md) |
...
The source map below describes the current strict-v9 successor runtime. Fitted
...
| [`ExperienceFeedback.cs`](../src/Chronicle.Visuals/ExperienceFeedback.cs) | Deterministic routine/decision/Chronicle emphasis bands plus semantic origin, contact, recipient, persistent-mark, and sound-cue plans derived from applied commands and Core state | Consumed by the Godot map and audio adapters; owns no time advancement or Chronicle decision |
...
| --- | --- | --- |
| [`ChronicleApp.cs`](../src/Chronicle.Godot/ChronicleApp.cs) | Lifecycle, map composition, input/HUD command routing, bounded visible-cell inspection, transient visible-map right-click routing through existing cardinal commands, save I/O, isolated UAT preparation, retained journeys, and the 17-stage Goal 7C Godot acceptance | Damage, eligibility, Load, timing, Agent/Directive decisions, movement legality, relationship, route persistence, or persistence semantics |
| [`ChronicleHud.cs`](../src/Chronicle.Godot/ChronicleHud.cs) | Map-first 1600×900 frame, one 320 px Context/Chronicle rail retaining Observation/Commitment/Consequence roles, compact lower-map action strip, semantic presentation colors, lower-map dialogue, focusable contextual actions, Clock, body state, and session-local sound/motion controls | Chronicle rules or alternate combat/power/Agent/Directive state; it presents snapshots and emits `ChronicleCommand` values |
| [`CodexLoadoutPanel.cs`](../src/Chronicle.Godot/CodexLoadoutPanel.cs) | Paused full-screen current-catalogue Codex, transient one-Verb proposal, learned/proposed/Attuned distinction, derived availability explanation, and explicit Attune/cancel/resume input parity | Word compatibility, Load, Link, capacity, or Attunement legality; these remain Core facts |
| [`TamarVoice.cs`](../src/Chronicle.Godot/TamarVoice.cs) | Five bounded reaction intents with two deterministic identity-selected cadence variants, composed only from current Agent and Directive snapshots | Agent state, personality statistics, dialogue branching, response choice, or runtime prose generation |
| [`SemanticAudioPlayer.cs`](../src/Chronicle.Godot/SemanticAudioPlayer.cs) | Session-local playback of deterministic semantic cue plans and sound-off parity | Simulation state, save data, command timing, or semantic cue selection |
...
| [`WorldVisualView.cs`](../src/Chronicle.Godot/WorldVisualView.cs) | One batched player-view draw surface over a shared `VisualRenderPlan`, plus bounded transient causal paths/cell emphasis and reduced-motion outlines | Semantic generation, variant selection, Chronicle timing, or durable world state |
...
| Source | Proves |
| --- | --- |
| [`Chronicle.Core.Checks/Program.cs`](../checks/Chronicle.Core.Checks/Program.cs) | Retained Goal 6 plus Goal 7 Agent/Directive mechanics, read-only Attunement preview, structural scale, persistence, death/replacement, strict v9, malformed state, replay, literal migrations, Core-copy isolation, and frozen predecessor bytes |
| [`Chronicle.Visuals.Checks/Program.cs`](../checks/Chronicle.Visuals.Checks/Program.cs) | P-GEN combat/material/Agent vocabulary, packaged/manual semantic parity, deterministic Goal 7C causal/cue roles, seven revised visual families, inspection/Directive semantics, adjacency, layering, crop, overlap, and numeric-address proof |
| [`verify.ps1`](../checks/verify.ps1) | P-GEN verification, packaged .NET builds, Core/Visual checks, Godot editor build, exact four-file package isolation, packaged/manual Inspector parity, complete retained Goal 6A–7B journeys, and 17 native Goal 7C Codex/rail/dialogue/accessibility captures |
...
| Source | Owns |
| --- | --- |
| [`play.ps1`](../play.ps1) | Canonical game build/launch using the normal save, any named isolated profile, a generated fresh profile, the self-preparing Goal 7A–7C UAT profiles, or Goal 7C sound-off/reduced-motion launch modes |
...
| [`POWER-PROGRESSION-DIRECTION.md`](POWER-PROGRESSION-DIRECTION.md) | Approved body/language/leverage progression model, effect-to-presentation contract, behavior-changing Modifier gate, ten-Verb/ten-Modifier breadth roster, Command acceptance, and contingent extraordinary-power stories; not production authority |
| [`EXPERIENCE-PASS-1-FROM-HARNESS-TO-GAME.md`](EXPERIENCE-PASS-1-FROM-HARNESS-TO-GAME.md) | Approved atmosphere north star, player voice, dialogue, three-tier information allocation, contextual rail, required semantic sound, three selected journeys, and bounded UX acceptance direction; not production authority |
| [`GOAL-7C-FROM-HARNESS-TO-GAME.md`](GOAL-7C-FROM-HARNESS-TO-GAME.md) | Completed and player-accepted presentation-only Goal 7C contract over the Primer/combat, Lode/Source, and Tamar/Directive journeys; six frozen fixture decisions and green retained/new automated gate |
...
| [`PALIMPSEST-CREATIVE-DIRECTOR-RESEARCH.md`](PALIMPSEST-CREATIVE-DIRECTOR-RESEARCH.md) | Primary-source take/reject synthesis for Qud, Dwarf Fortress, RimWorld, Path of Exile, and Cogmind plus the project-specific Creative Director decision protocol; research evidence rather than production authority |
...
- [Goal 6B — Power Comes Home contract and accepted result](GOAL-6B-POWER-COMES-HOME.md)
...
- [Power Progression Direction — From Spark to Catastrophe](POWER-PROGRESSION-DIRECTION.md)
- [Experience Pass 1 — From Harness to Game](EXPERIENCE-PASS-1-FROM-HARNESS-TO-GAME.md)
- [Goal 7C — From Harness to Game completed and player-accepted contract](GOAL-7C-FROM-HARNESS-TO-GAME.md)
- [Palimpsest's Creative Director — Primary-Source Research](PALIMPSEST-CREATIVE-DIRECTOR-RESEARCH.md)
